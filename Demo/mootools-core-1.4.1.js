...
web build:
 - http://mootools.net/core/ae7c64bcb01d2cd04afb31385d3b3e5b

packager build:
 - packager build Core/Core Core/Event Core/Class Core/Class.Extras Core/Element Core/Element.Event Core/Element.Dimensions Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/DOMReady
...
}var m=o.getAttributeNode("value");return(m&&m.specified)?o.value:o.get("text");}};}})();(function(){Element.Properties.events={set:function(b){this.addEvents(b);
...
},condition:function(b){return !!(this.type!="radio"||this.checked);}};}})();(function(){var f=document.html;Element.Properties.styles={set:function(i){this.setStyles(i);
